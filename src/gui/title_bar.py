...
class TitleBar(QFrame):
    def __init__(self, parent=None):
        ...
        self.settings_button.clicked.connect(self.title_parent.open_settings)
        ...
        self.minimize_button.clicked.connect(self.title_parent.showMinimized)
        ...
        self.maximize_restore_button.clicked.connect(self.title_parent.set_geometry)

        self.close_button = QPushButton("X", self)
        self.close_button.setFont(font)
        self.close_button.setObjectName("CloseButton")
        self.close_button.setFixedSize(45, 34)
        self.close_button.clicked.connect(self.title_parent.close)
